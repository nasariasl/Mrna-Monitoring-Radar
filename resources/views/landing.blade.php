            ...
            <div class="container px-4 px-lg-5 mt-5">
                <div class="row gx-4 gx-lg-5 row-cols-2 row-cols-md-3 row-cols-xl-4 justify-content-center" id="mernabody">
                    ...
                    <div class="col mb-5" onclick="mernaloadbody('1-ping-list.php');">
                        <div class="card">
                            <!-- Product image-->
                            <img class="card-img-top" src="{{ URL::asset('assets/Ping.png') }}" alt="..." />
                            <!-- Product details-->
                    ...
                    <div class="col mb-5" onclick="mernaload('2-mrt.php');">
                        <div class="card">
                            <!-- Product image-->
                            <img class="card-img-top" src="{{ URL::asset('assets/MRT.png') }}" alt="..." />
                            <!-- Product details-->
                            <div class="card-body p-4">
                                <div class="text-center">
                                    <!-- Product name-->
...
// objDiv.scrollTop = objDiv.scrollHeight;
 ...
 //$("#box").animate({ scrollTop: $('#box').prop("scrollHeight")}, 1000);
    ...
    <div id="box"> </div>
        ...
        <footer class="py-5 bg-dark">
            <div class="container"><p class="m-0 text-center text-white">Performance and security by mRNA</p></div>
   <style>
       .myspinner{
  position: fixed;
  left: 0px;
 ...
 background: url('https://www.node1.ir/{{ URL::asset('assets/Darman_Automation_Loading.gif') }}') 
              50% 50% no-repeat;
