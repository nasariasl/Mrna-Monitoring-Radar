...
//alert('ok');
 ...
 var interval = 3000; 
        ...
        document.getElementById("mernabtn").disabled = true;
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    if (response.status == 'OK') {
                        $("#box2").append($('<pre class="p-3 mb-2 text-left mw-100" style="direction: ltr !important;background-color: #212529;color: #deb887;">').html(response.replay)); 
...
<div class="container mt-3" id="box2">
  <h1>   آزمایش تست MRT/Trace Route</h1>
  ...
  <div class="input-group mb-3" >
    ...
    <div class="input-group-append">
      <button id="mernabtn" class="btn btn-primary" type="button" onclick="mernajson();" >شروع</button>
     </div>
  </div>      <br>
</div>
