    ...
    <table class="table table-dark w-auto small">
      <thead>
        ...
        <tr>
          ...
          <?php foreach ($column as $vkey => $v_element) { ?>
            <th scope="col" class="th-v"><span class="v_span"><?php echo jdate("H:i", $v_element['time']); ?></span> </th>
          <?php } ?>
      ...
      <tbody>
        <?php foreach ($row as $element) {
          ...
          <tr class="bg-primary text-white">
            ...
            <?php foreach ($column as $spark_element) {
              if ($spark_element['status'] == '1') {
                echo '<td class="online">';
              } else {
                echo '<td class="offline">';
              }
              echo '</td>';
            } ?>
