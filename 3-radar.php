            ...
            <tr class="bg-primary text-white">
              ...
              <td>
                <script>
                  ...
                  $("#sparkline_<?php echo $srv_id; ?>_<?php echo $url_id; ?>").sparkline([<?php foreach ($column as $spark_element) {
                          echo $spark_element['status'] . ',';
                        } ?>], {
                    type: 'tristate',
                    height: '20',
                    zeroBarColor: '#3f67a8',
                ...
                </script> <span id="sparkline_<?php echo $srv_id; ?>_<?php echo $url_id; ?>"></span>
              </td>
            </tr>
          <?php } ?>
        </tbody>
